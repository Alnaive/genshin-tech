...
<!-- <Equip :uid="uid" ></Equip> -->
    ...
    <div class="avatar absolute left-16 top-44 indicator">
        <div v-if="build.equipList[3].flat.rankLevel == 5" class="mb-8 rounded-btn w-12 h-12" :style="{ backgroundImage: 'url(' + bg5() + ')', backgroundSize:'contain' }">
            <div class="indicator-item avatar" >
                <div class="text-center rounded-btn w-6 h-6 font-bold" :style="{ backgroundImage: 'url(' + bg5() + ')', backgroundSize:'contain' }">
                    <img v-if="build.equipList[3].flat.reliquaryMainstat.mainPropId == 'FIGHT_PROP_ATTACK_PERCENT'" src="/image/svg/FIGHT_PROP_ATTACK_PERCENT.svg" class="ml-[3px] mt-[4px]" >
                    <img v-else-if="build.equipList[3].flat.reliquaryMainstat.mainPropId == 'FIGHT_PROP_DEFENSE_PERCENT'" src="/image/svg/FIGHT_PROP_DEFENSE_PERCENT.svg" class="ml-[3px] mt-[4px]" >
                    <img v-else-if="build.equipList[3].flat.reliquaryMainstat.mainPropId == 'FIGHT_PROP_HP_PERCENT'" src="/image/svg/FIGHT_PROP_HP_PERCENT.svg" class="ml-[3px] mt-[4px]" >
                    ...
                    <img v-else-if="build.equipList[3].flat.reliquaryMainstat.mainPropId == 'FIGHT_PROP_PHYSICAL_ADD_HURT'" src="/image/svg/FIGHT_PROP_PHYSICAL_ADD_HURT.svg" class="ml-[3px] mt-[4px]" >
    ...
    <div :key="index" class="avatar absolute left-16 top-60 indicator">
        <div v-if="build.equipList[4].flat.rankLevel == 5" class="mb-8 rounded-btn w-12 h-12" :style="{ backgroundImage: 'url(' + bg5() + ')', backgroundSize:'contain' }">
            <div class="indicator-item avatar" >
                <div class="text-center rounded-btn w-6 h-6 font-bold" :style="{ backgroundImage: 'url(' + bg5() + ')', backgroundSize:'contain' }">
                    <img v-if="build.equipList[4].flat.reliquaryMainstat.mainPropId == 'FIGHT_PROP_ATTACK_PERCENT'" src="/image/svg/FIGHT_PROP_ATTACK_PERCENT.svg" class="ml-[3px] mt-[4px]" >
                    <img v-else-if="build.equipList[4].flat.reliquaryMainstat.mainPropId == 'FIGHT_PROP_DEFENSE_PERCENT'" src="/image/svg/FIGHT_PROP_DEFENSE_PERCENT.svg" class="ml-[3px] mt-[4px]" >
                    <img v-else-if="build.equipList[4].flat.reliquaryMainstat.mainPropId == 'FIGHT_PROP_HP_PERCENT'" src="/image/svg/FIGHT_PROP_HP_PERCENT.svg" class="ml-[3px] mt-[4px]" >
