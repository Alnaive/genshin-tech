<template>
    <div v-for="weapon in weapons" :key="weapon.id" class="avatar absolute left-2 top-20 indicator">
        <div v-if="weapon.id == build.weapon_id && weapon.rarity == '5'"  class="mb-8 rounded-btn w-12 h-12 " 
        :style="{ backgroundImage: 'url(' + bg5() + ')', backgroundSize:'contain' }" v-on:click =" $emit('update:weaponDetail')">
            <div class="indicator-item avatar">
                <div v-if="weapon.id == build.weapon_id && weapon.rarity == '5'"  class="text-center rounded-btn w-6 h-6" :style="{ backgroundImage: 'url(' + bg5() + ')', backgroundSize:'contain' }">
                    {{refinement}}
                </div>
            </div> 
            <img  :src="weapon.icon" >
        </div>
         <div v-else-if="weapon.id == build.weapon_id && weapon.rarity == '4'"  class="mb-8 rounded-btn w-12 h-12 " 
        :style="{ backgroundImage: 'url(' + bg4() + ')', backgroundSize:'contain' }">
            <div class="indicator-item avatar">
                <div v-if="weapon.id == build.weapon_id && weapon.rarity == '4'"  class="text-center rounded-btn w-6 h-6" :style="{ backgroundImage: 'url(' + bg4() + ')', backgroundSize:'contain' }">
                    {{refinement}}
                </div>
            </div> 
            <img :src="weapon.icon" >
        </div>
         <div v-else-if="weapon.id == build.weapon_id && weapon.rarity == '3'"  class="mb-8 rounded-btn w-12 h-12 " 
        :style="{ backgroundImage: 'url(' + bg3() + ')', backgroundSize:'contain' }">
            <div class="indicator-item avatar">
                <div v-if="weapon.id == build.weapon_id && weapon.rarity == '3'"  class="text-center rounded-btn w-6 h-6" :style="{ backgroundImage: 'url(' + bg3() + ')', backgroundSize:'contain' }">
                    {{refinement}}
                </div>
            </div> 
            <img :src="weapon.icon" >
        </div>
         <div v-else-if="weapon.id == build.weapon_id && weapon.rarity == '2'"  class="mb-8 rounded-btn w-12 h-12 " 
        :style="{ backgroundImage: 'url(' + bg2() + ')', backgroundSize:'contain' }">
            <div class="indicator-item avatar">
                <div v-if="weapon.id == build.weapon_id && weapon.rarity == '2'"  class="text-center rounded-btn w-6 h-6" :style="{ backgroundImage: 'url(' + bg2() + ')', backgroundSize:'contain' }">
                    {{refinement}}
                </div>
            </div> 
            <img :src="weapon.icon" >
        </div>
         <div v-else-if="weapon.id == build.weapon_id && weapon.rarity == '1'"  class="mb-8 rounded-btn w-12 h-12 " 
        :style="{ backgroundImage: 'url(' + bg1() + ')', backgroundSize:'contain' }">
            <div class="indicator-item avatar">
                <div v-if="weapon.id == build.weapon_id && weapon.rarity == '1'"  class="text-center rounded-btn w-6 h-6" :style="{ backgroundImage: 'url(' + bg1() + ')', backgroundSize:'contain' }">
                    {{refinement}}
                </div>
            </div> 
            <img :src="weapon.icon" >
    ...
    <div v-for="artifact in artifactPcs" :key="artifact.id" class="avatar absolute left-2 top-36">
        <div v-if="flower_id == null" class="mb-8 rounded-btn w-12 h-12" :style="{ backgroundImage: 'url(' + bgRarity() + ')', backgroundSize:'contain' }">
        </div>
        <div v-else-if="artifact.id == flower_id && artifact.rarity == '5'" class="mb-8 rounded-btn w-12 h-12" 
        :style="{ backgroundImage: 'url(' + bg5() + ')', backgroundSize:'contain' }">
            <img :src="artifact.icon" >
        </div>
        <div v-else-if="artifact.id == flower_id && artifact.rarity == '4'" class="mb-8 rounded-btn w-12 h-12" 
        :style="{ backgroundImage: 'url(' + bg4() + ')', backgroundSize:'contain' }">
            <img :src="artifact.icon" >
        </div>
        <div v-else-if="artifact.id == flower_id && artifact.rarity == '3'" class="mb-8 rounded-btn w-12 h-12" 
        :style="{ backgroundImage: 'url(' + bg3() + ')', backgroundSize:'contain' }">
            <img :src="artifact.icon" >
        </div>
        <div v-else-if="artifact.id == flower_id && artifact.rarity == '2'" class="mb-8 rounded-btn w-12 h-12" 
        :style="{ backgroundImage: 'url(' + bg2() + ')', backgroundSize:'contain' }">
            <img :src="artifact.icon" >
        </div>
        <div v-else-if="artifact.id == flower_id && artifact.rarity == '1'" class="mb-8 rounded-btn w-12 h-12" 
        :style="{ backgroundImage: 'url(' + bg1() + ')', backgroundSize:'contain' }">
            <img :src="artifact.icon" >
        </div>
    </div>
    <div v-for="artifact in artifactPcs" :key="artifact.id"  class="avatar absolute left-2 top-52">
    ...
    <div v-for="artifact in artifactPcs" :key="artifact.id" class="avatar absolute left-16 top-28 indicator">
    ...
    <div v-for="artifact in artifactPcs" :key="artifact.id" class="avatar absolute left-16 top-44 indicator">
    ...
    <div v-for="artifact in artifactPcs" :key="artifact.id" class="avatar absolute left-16 top-60 indicator">
...
<script>
export default {
    props:['build','artifacts','artifactPcs','weapons','weapon_id','refinement','flower_id','plume_id','sand_id','goblet_id','circlet_id','main_sand','main_goblet','main_circlet'],
    methods: {
         showIconWeapon() {
