<template>
    <tab-panel v-for="data in uid.avatarInfoList" :key="data">
        ...
        <div v-for="char in character" :key="char.id">
            <div v-if="data.avatarId == char.id" class="artboard phone-3 artboard-demo card shadow-xl image-full bg-transparent" >
            <figure>
                    <img :src="showAvatar() + char.avatar" >
                </figure> 
                <div class="">
                    <h3 class="text-center text-black dark:text-white absolute inset-x-0 top-0 mt-5">{{char.name}}  Lv {{data.propMap[4001]['val']}}
                        <br> <p> {{uid.playerInfo.nickname}} </p>
                    </h3>
                    <!-- <Equip :uid="uid" ></Equip> -->
                    ...
                    <!-- end of equip -->
                    <!-- <Party :uid="uid" />  -->
                    <div  class="space-x-2 absolute left-1 top-[50%]">
                        ...
                        <div v-else-if="Object.keys(data.proudSkillExtraLevelMap).length == 1" class="flex flex-row space-x-4">
                        ...
                        <div v-else-if="Object.keys(data.proudSkillExtraLevelMap).length == 2" class="flex flex-row space-x-4">
                        ...
                        <div v-else-if="Object.keys(data.proudSkillExtraLevelMap).length == 3" class="flex flex-row space-x-4">
                    ...
                    <ul  class="flex flex-col w-12 py-1  bg-transparent  absolute right-4 top-16 space-y-1" >
                        <li v-if="data.talentIdList">
                            <div class="avatar">
                                <div v-if="data.talentIdList.length == 1" class=" rounded-full w-10 h-10 ring  bg-black opacity-50">
                                    <img :src=" `https://enka.shinshin.moe/ui/${char.Consts[0]}.png`">
                                </div>
                                <div v-else class=" rounded-full w-10 h-10 ring  bg-black">
                                    <img :src=" `https://enka.shinshin.moe/ui/${char.Consts[0]}.png`">
                                </div>
                            </div>
                            <div class="avatar">
                            ...
                            <div class="avatar">
                                <div v-if="data.talentIdList.length <= 2" class=" rounded-full w-10 h-10 ring  bg-black opacity-50">
                            ...
                            <div class="avatar">
                                <div v-if="data.talentIdList.length <= 3" class=" rounded-full w-10 h-10 ring  bg-black opacity-50">
                            ...
                            <div class="avatar">
                                <div v-if="data.talentIdList.length <= 4" class=" rounded-full w-10 h-10 ring  bg-black opacity-50">
                            ...
                            <div class="avatar">
                                <div v-if="data.talentIdList.length <= 5" class=" rounded-full w-10 h-10 ring  bg-black opacity-50">
                            ...
                            <div v-if="data.talentIdList.length == 3" class=" absolute right-5">
                        ...
                        <li v-else>
                                ...
                                <div  class=" rounded-full w-10 h-10 ring  bg-black" :style="{ backgroundImage: 'url(' +  `https://enka.shinshin.moe/ui/${cons}.png` + ')', backgroundSize:'contain', backgroundColor:'black', opacity:'50' }">
        ...
        <button class="btn btn-success" @click="addC(data)">Add</button>
        </div>
        </tab-panel>
</template>
<script>
